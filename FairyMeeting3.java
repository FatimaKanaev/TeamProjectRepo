...
/**
 * Write a description of class FairyMeeting3 here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class FairyMeeting3 extends World
{

    /**
     * Constructor for objects of class FairyMeeting3.
     * 
     */
    public FairyMeeting3()
    {    
    ...
    private void prepare()
    {
        ...
        addObject(goodBernard,419,85);
        GoodBernard goodBernard2 = new GoodBernard();
        addObject(goodBernard2,429,138);
        GoodBernard goodBernard3 = new GoodBernard();
        addObject(goodBernard3,391,142);
    }
}
